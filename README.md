...
- `samples/` (git-ignored) — raw captures, stills and bandwidth summaries pulled from the test machine;
  refresh with `rsync -a walden-lab@roadkill0.local:captures/ samples/captures/` (`samples/README.txt`)
