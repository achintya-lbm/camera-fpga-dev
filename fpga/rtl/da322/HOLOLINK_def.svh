...
//-----------------------------------------------------
  ...
  `define UUID                 128'h2b64_85ba_a2c4_4b58_aee2_b4d5_e623_927e // Tauro DA322 (same UUID as the vendor image so the host's DA322 board module matches)
  ...
  //`define ENUM_EEPROM   // DA322 first build: soft MAC/serial below (EEPROM wiring unverified; see fpga/rtl/da322/README.md)
  ...
  `endif
  `ifndef ENUM_EEPROM
    `define MAC_ADDR  48'hCAFEC0FFEE22
    `define BOARD_VER 160'h0
    `define BOARD_SN  56'h0DA322
